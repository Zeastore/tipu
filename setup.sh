...
orange='\e[0;33m'
NC='\e[0m'
export REPO="https://raw.githubusercontent.com/freetunnel/ftp/main"
...
#wget -q -O /usr/share/nginx/html/index.html "https://raw.githubusercontent.com/NiLphreakzz/XRAY-MULTIPORT/main/OTHERS/index.html"
...
echo -e "${RB}      '-------------------------------------------'${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e " ${WB}Multiport Websocket Autoscript By FREE TUNNELING PROJECT${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
